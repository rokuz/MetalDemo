...
void ArcballCamera::stopRotation() { isRotating = false; }
...
void ArcballCamera::stopZooming() { isZooming = false; }
...
simd::float2 ArcballCamera::getLastFingerPosition() const { return lastFingerPosition; }

bool ArcballCamera::isRotatingNow() const { return isRotating; }

bool ArcballCamera::isZoomingNow() const { return isZooming; }

simd::float3 ArcballCamera::getCurrentViewPosition() const { return currentViewPosition; }
